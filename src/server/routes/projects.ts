...
export const scanProjects = async (req: Request, res: Response) => {
  try {
...
export const clearActiveProject = async (req: Request, res: Response) => {
  try {
    const userId = req.query.userId as string || 'default';
...
export const switchToProject = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const userId = req.body.userId || 'default';
...
export const getProjectNavigationHistory = async (req: Request, res: Response) => {
  try {
    const userId = req.query.userId as string || 'default';
