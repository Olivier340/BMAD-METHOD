...
agentsRouter.post('/deactivate/:sessionId', async (req: Request, res: Response) => {
  try {
...
agentsRouter.get('/:projectId/agent/:agentId', async (req: Request, res: Response) => {
  try {
...
agentsRouter.post('/:projectId/agent/:agentId/configure', async (req: Request, res: Response) => {
  try {
    const { projectId, agentId } = req.params;
...
agentsRouter.post('/:projectId/agent/:agentId/reload', async (req: Request, res: Response) => {
  try {
...
agentsRouter.post('/:projectId/agent/:agentId/validate', async (req: Request, res: Response) => {
  try {
    const { projectId, agentId } = req.params;
    const projectPath = (req.query.path as string) || process.cwd();
