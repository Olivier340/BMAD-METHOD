...
describe('AgentService - Agent Management', () => {
  ...
  describe('Agent Discovery', () => {
    ...
    it('should validate agent structure', async () => {
      ...
      const validation = await agentService.validateAgent(mockAgent);
  ...
  describe('Agent Capabilities', () => {
    ...
    it('should validate capability structure', async () => {
      ...
      const validation = await agentService.validateAgent(agentWithInvalidCapabilities);
  ...
  describe('Error Handling', () => {
    ...
    it('should handle malformed agent configurations', async () => {
      ...
      const validation = await agentService.validateAgent(malformedAgent);
      expect(validation.valid).toBe(false);
      expect(validation.errors.length).toBeGreaterThan(0);
    });
  });
