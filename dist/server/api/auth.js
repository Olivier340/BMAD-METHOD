...
authRouter.get('/me', authService.createAuthMiddleware(), async (req, res) => {
  try {
    if (!req.user) {
...
authRouter.get('/users', authService.createAuthMiddleware(), authService.createRoleMiddleware(['admin']), async (req, res) => {
  try {
...
authRouter.put('/users/:userId', authService.createAuthMiddleware(), authService.createRoleMiddleware(['admin']), async (req, res) => {
  try {
...
authRouter.delete('/users/:userId', authService.createAuthMiddleware(), authService.createRoleMiddleware(['admin']), async (req, res) => {
  try {
    const { userId } = req.params;
